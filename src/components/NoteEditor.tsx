    ...
    <div className="flex-1 flex flex-col bg-card text-foreground rounded-none sm:rounded-3xl shadow-none sm:shadow-2xl border-0 sm:border border-border overflow-hidden glass h-full">
      ...
      <div className="p-4 sm:p-8 space-y-6 sm:space-y-12">
        ...
        <div className="space-y-6 sm:space-y-8">
          ...
          {cSuiteEval && (
            <div className="bg-transparent sm:bg-muted/5 border-0 sm:border border-border/50 rounded-none sm:rounded-3xl p-4 sm:p-8 space-y-4 sm:space-y-6 relative overflow-hidden group transition-all hover:bg-muted/10">
              <div className="absolute top-0 bottom-0 left-0 w-1 bg-indigo-500 opacity-40 group-hover:opacity-100 transition-all duration-300"></div>
